...
<form class="row g-3" action="" method="post">
    <div class="col-md-5">
        ...
        <input type="text" class="form-control" id="inputID" placeholder="National Identity Number" name="Id">
    </div>
    <?php
    if(isset($errors['ID'])) {
    ...
    <div class="col-md-5">
        ...
        <input type="text" class="form-control" id="inputFN" placeholder="First Name" name="FirstName">
    </div>
    <?php
    ...
    <div class="col-md-5">
        ...
        <input type="text" class="form-control" id="inputLN" placeholder="Last Name" name="LastName">
    </div>
    <?php
    ...
    <div class="col-md-5">
        ...
        <input type="password" class="form-control" id="pwhold" placeholder="Password" name="Password">
    </div>
    <?php
    ...
    <div class="col-md-5">
        ...
        <input type="url" class="form-control" id="adress" placeholder="...,Morocco" name="Adress">
    </div>
    <?php
    ...
    <div class="col-md-5">
        ...
        <input type="text" class="form-control" id="state" placeholder="Morocco" name="State">
    </div>
    <?php
    ...
    <div class="col-md-5">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Spring" id="flexCheckDefault" name="Community[]">
            <label class="form-check-label" for="flexCheckDefault">
                Spring
            </label>
        </div>
        <div class="form-_check">
            <input class="form-check-input" type="checkbox" value="JAKARTA EE" id="flexCheckDefault2" name="Community[]">
            <label class="form-check-label" for="flexCheckDefault2">
                JAKARTA EE
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Hibernate" id="flexCheckbox" name="Community[]">
    ...
    <div class="col-md-5">
        Gender
        <div class="form-check">
            <input class="form-check-input" type="radio" name="Gender" id="flexRadioDefault1" value="Female">Female
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="Gender" id="flexRadioDefault2" value="Male">Male
        </div>
    </div>
    <?php
